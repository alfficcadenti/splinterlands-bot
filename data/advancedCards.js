...
getAdvancedCards = (username) => (fetch(`https://game-api.splinterlands.io/cards/collection/${username}?v=1583787547346&token=W5T4K3GWY8&username=${username}`, 
    {"credentials":"omit","headers":{"accept":"application/json, text/javascript, */*; q=0.01"},"referrer":"https://splinterlands.com/?p=collection&a=a1492dc","referrerPolicy":"no-referrer-when-downgrade","body":null,"method":"GET","mode":"cors"})
    .then(x => x.json())
...
async function asyncCall() {
    const result = await getAdvancedCards('a1492dc');
    console.log(result);
